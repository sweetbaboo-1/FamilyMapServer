...
public class EventDaoTest {
    ...
    @Test
    public void getEventByType() throws DataAccessException {
        eDao.insert(bestEvent);
        Event event = eDao.getEventByType("Gale123A", "Biking_Around");
        assertEquals(bestEvent, event);
    }
    ...
    @Test
    public void getAllEventsRelatedToUsernamePass() throws DataAccessException{
        eDao.insert(bestEvent);
        List<Event> events = eDao.getAllEventsRelatedToUsername("Gale");
        assertEquals(events.get(0).toString(), bestEvent.toString());
    }

    @Test
    public void getAllEventsRelatedToUsernameFail() throws DataAccessException{
        eDao.insert(bestEvent);
        List<Event> events = eDao.getAllEventsRelatedToUsername("bob");
